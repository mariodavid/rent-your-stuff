...
public class OrderAssert extends AbstractObjectAssert<OrderAssert, Order> {
   ...
   */
  public OrderAssert hasCustomer(de.diedavids.jmix.rys.customer.Customer customer) {
    // check that actual Order we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    de.diedavids.jmix.rys.customer.Customer actualCustomer = actual.getCustomer();
