...
public class OrderLineAssert extends AbstractObjectAssert<OrderLineAssert, OrderLine> {
   ...
   */
  public OrderLineAssert hasStockItem(de.diedavids.jmix.rys.product.StockItem stockItem) {
    // check that actual OrderLine we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    de.diedavids.jmix.rys.product.StockItem actualStockItem = actual.getStockItem();
